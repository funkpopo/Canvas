...
import { Activity, Loader2, RefreshCw, Play, Trash2, FileText } from "lucide-react";
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <section className="py-4 border-b last:border-b-0">
          <div className="flex items-center justify-between mb-1">
            <h3 className="text-sm font-medium">{t("completion")}</h3>
        ...
        <section className="py-4 border-b last:border-b-0">
          <div className="flex items-center justify-between mb-1">
            <h3 className="text-sm font-medium">{t("activePods")}</h3>
            <Activity className="h-4 w-4 text-muted-foreground" />
          </div>
        ...
        <section className="py-4 border-b last:border-b-0">
          <div className="flex items-center justify-between mb-1">
            <h3 className="text-sm font-medium">{t("age")}</h3>
            <Activity className="h-4 w-4 text-muted-foreground" />
          </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        ...
        <TabsContent value="overview" className="space-y-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* Basic info */}
            <section className="py-4 border-b last:border-b-0">
              <h3 className="text-sm font-medium mb-3">{t("basicInfo")}</h3>
            ...
            {/* Conditions */}
            <section className="py-4 border-b last:border-b-0">
              <h3 className="text-sm font-medium mb-3">{t("conditionsTitle")}</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {Object.keys(jobDetails.labels).length > 0 && (
              <section className="py-4 border-b last:border-b-0">
                <h3 className="text-sm font-medium mb-3">{t("labelsTitle")}</h3>
            ...
            {Object.keys(jobDetails.annotations).length > 0 && (
              <section className="py-4 border-b last:border-b-0">
                <h3 className="text-sm font-medium mb-3">{t("annotationsTitle")}</h3>
        ...
        <TabsContent value="pods" className="space-y-4">
          <section className="py-4">
            <h3 className="text-sm font-medium mb-1">{t("relatedPodsTitle")}</h3>
