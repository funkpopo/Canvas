...
export default function StorageManagement() {
  ...
  const handleDeleteStorageClass = async (scName: string) => {
    ...
    try {
      ...
      setStorageClasses(
        storageClasses.filter((sc) => sc.cluster_id === selectedClusterId && sc.name !== scName)
      );
    } catch (error) {
  ...
  const handleDeletePVC = async (namespace: string, pvcName: string) => {
    ...
    try {
      ...
      setPersistentVolumeClaims(
        persistentVolumeClaims.filter(
          (pvc) => !(pvc.namespace === namespace && pvc.name === pvcName)
        )
      );
    } catch (error) {
    ...
    <div className="space-y-6">
      ...
      {!activeCluster && !isLoading && !clusterLoading ? (
        <div className="flex flex-col items-center justify-center min-h-[400px] text-center">
          ...
          <h2 className="text-2xl font-semibold mb-2">{t("noActiveClusterTitle")}</h2>
          <p className="text-muted-foreground mb-4">{t("noActiveClusterDescription")}</p>
          <div className="text-sm text-muted-foreground mt-4">
            <p>{t("authStatus", { status: t("statusAuthenticated") })}</p>
            <p>{t("clusterCount", { count: clusters.length })}</p>
            <p>
              {t("activeClusterStatus", {
                status: activeCluster ? t("statusSelected") : t("statusNone"),
              })}
            </p>
          </div>
          <Button asChild>
            <Link href="/clusters/new">{t("createCluster")}</Link>
          </Button>
        </div>
      ) : (
        <div className="space-y-6">
                        ...
                        <DialogContent>
                          ...
                          <div className="grid gap-4 py-4">
                            <div className="grid grid-cols-4 items-center gap-4">
                              <Label htmlFor="sc-name" className="text-right">
                                {t("nameLabel")}
                              </Label>
                              <Input
                                id="sc-name"
                            ...
                            <div className="grid grid-cols-4 items-center gap-4">
                              ...
                              <div className="col-span-3 flex items-center space-x-2">
                                <Select
                                  value={scForm.custom_provisioner ? "custom" : "preset"}
                                  onValueChange={(value) =>
                                    setScForm({
                                      ...scForm,
                                      custom_provisioner: value === "custom",
                                      provisioner: value === "custom" ? "" : scForm.provisioner,
                                      provisioner_image:
                                        value === "custom" ? scForm.provisioner_image : "",
                                    })
                                  }
                                >
                            ...
                            {scForm.custom_provisioner ? (
                              <div className="grid grid-cols-4 items-center gap-4">
                                <Label htmlFor="sc-custom-provisioner" className="text-right">
                                  Provisioner
                                </Label>
                                <Input
                                  ...
                                  onChange={(e) =>
                                    setScForm({ ...scForm, provisioner: e.target.value })
                                  }
                                  className="col-span-3"
                              ...
                              <div className="grid grid-cols-4 items-center gap-4">
                                <Label htmlFor="sc-provisioner" className="text-right">
                                  Provisioner
                                </Label>
                                <Select
                                  value={scForm.provisioner}
                                ...
                                >
                                  ...
                                  <SelectContent>
                                    ...
                                    <SelectItem value="kubernetes.io/nfs">
                                      {t("nfsBuiltIn")}
                                    </SelectItem>
                                    <SelectItem value="k8s-sigs.io/nfs-subdir-external-provisioner">
                                      NFS Subdir External Provisioner
                                    </SelectItem>
                                    <SelectItem value="kubernetes.io/host-path">
                                      Host Path
                                    </SelectItem>
                                  </SelectContent>
                                </Select>
                            ...
                            {scForm.custom_provisioner && (
                              <div className="grid grid-cols-4 items-center gap-4">
                                <Label htmlFor="sc-provisioner-image" className="text-right">
                                  {t("provisionerImageLabel")}
                                </Label>
                                <Input
                                  id="sc-provisioner-image"
                                  value={scForm.provisioner_image}
                                  onChange={(e) =>
                                    setScForm({ ...scForm, provisioner_image: e.target.value })
                                  }
                                  className="col-span-3"
                            ...
                            {(scForm.provisioner === "kubernetes.io/nfs" ||
                              ...
                              <>
                                <div className="grid grid-cols-4 items-center gap-4">
                                  <Label htmlFor="sc-nfs-server" className="text-right">
                                    {t("nfsServerLabel")}
                                  </Label>
                                  <Input
                                    id="sc-nfs-server"
                                    ...
                                    onChange={(e) =>
                                      setScForm({ ...scForm, nfs_server: e.target.value })
                                    }
                                    className="col-span-3"
                                ...
                                <div className="grid grid-cols-4 items-center gap-4">
                                  <Label htmlFor="sc-nfs-path" className="text-right">
                                    {t("nfsPathLabel")}
                                  </Label>
                                  <Input
                                    id="sc-nfs-path"
                                    ...
                                    onChange={(e) =>
                                      setScForm({ ...scForm, nfs_path: e.target.value })
                                    }
                                    className="col-span-3"
                            ...
                            {scForm.provisioner === "k8s-sigs.io/nfs-subdir-external-provisioner" &&
                              !scForm.custom_provisioner && (
                                <div className="grid grid-cols-4 items-center gap-4">
                                  <Label htmlFor="sc-provisioner-image" className="text-right">
                                    {t("provisionerImageLabel")}
                                  ...
                                  <Input
                                    id="sc-provisioner-image"
                                    value={
                                      scForm.provisioner_image ||
                                      "eipwork/nfs-subdir-external-provisioner"
                                    }
                                    onChange={(e) =>
                                      setScForm({ ...scForm, provisioner_image: e.target.value })
                                    }
                            ...
                            <div className="grid grid-cols-4 items-center gap-4">
                              <Label htmlFor="sc-reclaim" className="text-right">
                                {t("reclaimPolicyLabel")}
                              </Label>
                              <Select
                                value={scForm.reclaim_policy}
                                onValueChange={(value) =>
                                  setScForm({ ...scForm, reclaim_policy: value })
                                }
                              >
                                <SelectTrigger className="col-span-3">
                                  <SelectValue />
                            ...
                            <div className="grid grid-cols-4 items-center gap-4">
                              <Label htmlFor="sc-binding-mode" className="text-right">
                                {t("bindingModeLabel")}
                              </Label>
                              <Select
                                value={scForm.volume_binding_mode}
                                onValueChange={(value) =>
                                  setScForm({ ...scForm, volume_binding_mode: value })
                                }
                              >
                                <SelectTrigger className="col-span-3">
                                  <SelectValue />
                          ...
                          {storageClasses.map((sc) => (
                            <TableRow key={`${sc.cluster_id}-${sc.name}`}>
                              ...
                              <TableCell>
                                <Badge
                                  variant={
                                    sc.reclaim_policy === "Delete" ? "destructive" : "secondary"
                                  }
                                >
                                  {sc.reclaim_policy}
                                </Badge>
                              ...
                              <TableCell>
                                {sc.allow_volume_expansion ? t("yes") : t("no")}
                              </TableCell>
                      ...
                      <Dialog open={isCreatePVOpen} onOpenChange={setIsCreatePVOpen}>
                        ...
                        <DialogContent>
                          <DialogHeader>
                            ...
                            <DialogDescription>{t("createVolumeDescription")}</DialogDescription>
                          </DialogHeader>
                          <div className="grid gap-4 py-4">
                            <div className="grid grid-cols-4 items-center gap-4">
                              <Label htmlFor="pv-name" className="text-right">
                                {t("nameLabel")}
                              </Label>
                              <Input
                                id="pv-name"
                            ...
                            <div className="grid grid-cols-4 items-center gap-4">
                              <Label htmlFor="pv-capacity" className="text-right">
                                {t("capacityLabel")}
                              </Label>
                              <Input
                                id="pv-capacity"
                            ...
                            <div className="grid grid-cols-4 items-center gap-4">
                              <Label htmlFor="pv-hostpath" className="text-right">
                                Host Path
                              </Label>
                              <Input
                                id="pv-hostpath"
                                ...
                                onChange={(e) =>
                                  setPvForm({ ...pvForm, host_path: e.target.value })
                                }
                                className="col-span-3"
                        ...
                        <TableBody>
                          {persistentVolumes.map((pv) => (
                            <TableRow key={pv.name}>
                              ...
                              <TableCell>
                                <Badge
                                  variant={pv.status === "Available" ? "default" : "secondary"}
                                >
                                  {pv.status}
                                </Badge>
                              </TableCell>
                      ...
                      <Dialog open={isCreatePVCOpen} onOpenChange={setIsCreatePVCOpen}>
                        ...
                        <DialogContent>
                          <DialogHeader>
                            ...
                            <DialogDescription>{t("createPvcDescription")}</DialogDescription>
                          </DialogHeader>
                          <div className="grid gap-4 py-4">
                            <div className="grid grid-cols-4 items-center gap-4">
                              <Label htmlFor="pvc-name" className="text-right">
                                {t("nameLabel")}
                              </Label>
                              <Input
                                id="pvc-name"
                            ...
                            <div className="grid grid-cols-4 items-center gap-4">
                              <Label htmlFor="pvc-namespace" className="text-right">
                                {t("namespaceLabel")}
                              </Label>
                              <Input
                                id="pvc-namespace"
                                ...
                                onChange={(e) =>
                                  setPvcForm({ ...pvcForm, namespace: e.target.value })
                                }
                                className="col-span-3"
                                placeholder="default"
                              />
                            ...
                            <div className="grid grid-cols-4 items-center gap-4">
                              <Label htmlFor="pvc-storage" className="text-right">
                                {t("storageSizeLabel")}
                              </Label>
                              <Input
                                id="pvc-storage"
                                ...
                                onChange={(e) =>
                                  setPvcForm({ ...pvcForm, storage: e.target.value })
                                }
                                className="col-span-3"
                                placeholder="1Gi"
                              />
