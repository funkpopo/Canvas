            ...
            <table className="w-full text-sm">
              <thead className="bg-muted">
                <tr className="text-left text-text-muted">
                  <th className="px-3 py-2">{t("policies.col.name")}</th>
                  <th className="px-3 py-2">{t("policies.col.namespace")}</th>
                  <th className="px-3 py-2">{t("policies.col.created")}</th>
                  <th className="px-3 py-2">{t("policies.col.actions")}</th>
                </tr>
              </thead>
              <tbody>
                {isLoading ? (
                  ...
                  <tr><td className="px-3 py-4 text-text-muted" colSpan={3}>{t("policies.empty")}</td></tr>
                ) : (
                  items.map((it) => (
