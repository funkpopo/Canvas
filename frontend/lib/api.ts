...
// ===== Pod API =====
export const podApi = {
  async getPods(clusterId: number, namespace: string | undefined, limit: number, continueToken: string | null): Promise<ApiResponse<{ items: Pod[]; continue_token: string | null }>> {
    const params = new URLSearchParams();
