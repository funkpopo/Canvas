...
from app.services.resources.config import SecretService
...
async def get_secret_yaml(namespace: str, name: str, service: SecretService = Depends(get_secret_service)) -> YamlContent:
...
async def put_secret_yaml(namespace: str, name: str, payload: YamlContent, service: SecretService = Depends(get_secret_service)) -> OperationResult:
...
async def delete_secret(namespace: str, name: str, service: SecretService = Depends(get_secret_service)) -> OperationResult:
